...
<!-- Section-->
<section class="py-5">
    <div class="container-fluid px-4 bg-dark px-lg-5 mt-5">
    <?php 
        ...
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
            ...
            ?>
            <div class="col mb-5">
                <div onMouseOver="this.style.color='gold'" onMouseOut="this.style.color='blue'" style= " box-shadow: 30px 30px 100px -45px rgb(255, 217, 1);"
                        class="card h-100 product-item">
                    <!-- Product image-->
                    ...
                    <!-- Product actions-->
                    <div class="card-footer p-4 pt-0 border-top-0 bg-dark text-light">
                        <div class="text-center">
                            <a class="btn btn-flat btn-info "   href=".?p=view_product&id=<?php echo md5($row['id']) ?>">More Details</a>
                        </div>
