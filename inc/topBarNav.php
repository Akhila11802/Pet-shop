            ...
            <div class="container px-4 px-lg-5 ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <?php endif; ?>
                        <?php endwhile; ?>
                        <li class="nav-item dropdown" id="navbarDropdown"> <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">Pet info<b ></b></a> 
                          <ul class="dropdown-menu p-0" aria-labelledby="navbarDropdown"> 

                            <li><a class="dropdown-item border-bottom" href="./?p=dog_info">Dog_info</a>  </li> 

                            <li><a class="dropdown-item border-bottom" href="./?p=cat_info">Cat_info</a> </li> 
                          </ul> 
                        ...
                        <li class="nav-item"><a class="nav-link" href="./?p=team">Team members</a></li>
                        <li class="nav-item"><a class="nav-link" href="./?p=about">About</a></li>
                        <li class="nav-item"><a class="nav-link" href="./?p=location">Location</a></li>
